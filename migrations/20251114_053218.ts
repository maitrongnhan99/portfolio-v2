...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_projects_category" AS ENUM('FullStack', 'Frontend', 'Backend', 'Mobile', 'API', 'Tool');
  CREATE TYPE "public"."enum_projects_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__projects_v_version_category" AS ENUM('FullStack', 'Frontend', 'Backend', 'Mobile', 'API', 'Tool');
  CREATE TYPE "public"."enum__projects_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_media_usage" AS ENUM('project', 'profile', 'general', 'gallery');
  ...
  CREATE TABLE "settings" (
  	...
  	"enable_payload" boolean DEFAULT true,
  ...
  ALTER TABLE "_projects_v" ADD CONSTRAINT "_projects_v_version_reviewed_by_id_users_id_fk" FOREIGN KEY ("version_reviewed_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
