...
const nextConfig = {
  ...
  images: {
    ...
    minimumCacheTTL: 60 * 60 * 24 * 31, // 31 days — optimized images are content-addressed and rarely change
    ...
    remotePatterns: [
      ...
      {
        protocol: "https",
        hostname: "maitrongnhan99.vercel.app",
        port: "",
        pathname: "/api/media/**",
      },
      {
        protocol: "https",
        hostname: "xiaw58us2q2emqf3.public.blob.vercel-storage.com",
        port: "",
        pathname: "/**",
      },
    ],
