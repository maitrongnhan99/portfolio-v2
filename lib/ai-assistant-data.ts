...
export const personalInfo = {
  ...
  experience: [
    ...
    },
    {
      ...
      period: "2022 - 2023",
      description:
        "Specialized in React and Next.js development for enterprise applications",
    },
  ],
  ...
  projects: [
    {
      ...
      description:
        "Video course teaching Spotify Web API integration with React and Express",
      technologies: ["React", "Express", "Spotify API", "Node.js"],
    },
    {
      name: "Spotify Profile",
      description:
        "Web app for visualizing personalized Spotify data and music preferences",
      technologies: ["React", "Express", "Spotify API", "Heroku"],
    },
    {
      name: "Halcyon Theme",
      description:
        "Minimal dark blue theme for VS Code, Sublime Text, Atom, and iTerm",
      technologies: ["VS Code", "Sublime Text", "Atom", "iTerm"],
    },
    {
      name: "Portfolio Website",
      description:
        "Personal portfolio built with Next.js and modern web technologies",
...
I'm passionate about creating full-stack applications with modern, scalable architectures.`;
  ...
  if (
    ...
    const experienceList = personalInfo.experience
      .map(
        (exp) =>
...
I've been focusing on building accessible, user-centered products using modern web technologies.`;
  ...
  if (
    ...
    const projectList = personalInfo.projects
      .map(
        (project) =>
          `• **${project.name}**: ${
            project.description
...
I'm always open to discussing new opportunities and interesting projects!`;
  ...
  if (
    ...
    return `My interests include: ${personalInfo.interests.join(
      ", "
    )}. I'm passionate about creating technology that makes a positive impact and continuously learning new development techniques.`;
  }
