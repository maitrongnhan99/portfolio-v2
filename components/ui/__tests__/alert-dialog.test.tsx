...
describe("AlertDialog Components", () => {
  describe("AlertDialog Root", () => {
    ...
    it("should not render content when closed", () => {
      ...
      expect(
        screen.queryByTestId("alert-dialog-title")
  ...
  describe("AlertDialogOverlay", () => {
      ...
      render(
        <AlertDialog open>
          <AlertDialogContent>
            ...
            <AlertDialogDescription>Dialog with overlay</AlertDialogDescription>
          </AlertDialogContent>
        </AlertDialog>
      );
    ...
    it("should render with custom className", () => {
      ...
      const customOverlay = overlays.find((overlay) =>
        overlay.classList.contains("custom-overlay")
      );
      ...
      render(
        <AlertDialog open>
          <AlertDialogContent ref={ref}>
            ...
            <AlertDialogDescription>Dialog with ref</AlertDialogDescription>
          </AlertDialogContent>
        </AlertDialog>
      );
    ...
    it("should render with default classes", () => {
      render(
        <AlertDialog open>
          <AlertDialogContent>
            <AlertDialogTitle>Dialog</AlertDialogTitle>
            <AlertDialogDescription>Dialog with footer</AlertDialogDescription>
            <AlertDialogFooter>
  ...
  describe("AlertDialogTitle", () => {
      ...
      render(
        <AlertDialog open>
          <AlertDialogContent>
            ...
            <AlertDialogDescription>Title with ref</AlertDialogDescription>
          </AlertDialogContent>
        </AlertDialog>
      );
    ...
    it("should support HTML heading attributes", () => {
      render(
        <AlertDialog open>
          <AlertDialogContent>
            <AlertDialogTitle aria-level={2}>Accessible Title</AlertDialogTitle>
            <AlertDialogDescription>
      ...
      render(
        <AlertDialog open>
          <AlertDialogContent>
            <AlertDialogTitle>Dialog</AlertDialogTitle>
            <AlertDialogDescription>
              Dialog with cancel button and responsive margin
            </AlertDialogDescription>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
          </AlertDialogContent>
        </AlertDialog>
      ...
      render(
        <AlertDialog open>
          <AlertDialogContent>
            ...
            <AlertDialogDescription>Empty title dialog</AlertDialogDescription>
          </AlertDialogContent>
        </AlertDialog>
      );
