...
export const ChatHeader = React.memo(({ currentConversation }: ChatHeaderProps) => {
  return (
    ...
    >
      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-transparent border border-border flex items-center justify-center shrink-0">
      ...
      <div className="min-w-0">
        <h1 className="text-base sm:text-xl font-bold text-text-primary flex items-center gap-1 sm:gap-2">
          ...
          <SparkleIcon className="w-4 h-4 sm:w-5 sm:h-5 text-text-secondary shrink-0" />
        </h1>
